...
export class StepperComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.steps = [
          ...
          types: [
            {
              ...
              value: 'concept',
              fields: ['(E.g. Branding, UI, illustration)', 'Original concept design for a product or a machine']
            },
            {
              id: 2,
              text: 'Original idea',
            ...
            },
            {
              ...
              value: 'research',
              fields: ['Research papers published or about to get published.', 'Code source for a product Or part of a product.']
            },
          ],
        },
        ...
        data: {
          types: [
            ...
            },
            {
              ...
              value: 'company',
              fields: ['Company VAT number', 'Company address', 'Contact person details']
            },
            {
              id: 3,
              ...
              value: 'group',
              fields: ['Country of residency', 'Email address', 'Phone number', 'Nationality', 'ID number']
            },
          ],
        },
        togglers: [{ id: 1, name: 'Owner(s) type' }, { id: 2, name: 'Owner(s) details' }],
        activeToggler: 1,
        dynamicRequired: {
          individual: {
            recursive: false,
            fields: ['full_name', 'id_number', 'email', 'phone_number', 'country_of_residency', 'nationality']
          },
          company: {
            recursive: false,
            fields: ['company_name', 'company_country', 'company_city', 'zip_code', 'vat', 'name', 'nationality', 'id_number', 'country_of_residency', 'email', 'phone_number']
          },
          group: {
            recursive: true,
            fields: ['name', 'id_number', 'country_of_residency', 'nationality']
          }
        },
      ...
      },
      {
        ...
        data: {},
        togglers: [{ id: 1, name: 'Review' }, { id: 2, name: 'Payment' }],
        activeToggler: 1,
        required: []
      },
    ]
  ...
  checkDisabled() {
    ...
    if (step.dynamicRequired && step.fields[step.fieldsToCheckForDynamic]) {
      let required = step.dynamicRequired[step.fields[step.fieldsToCheckForDynamic]];
  ...
  setter(field, value, toggler = null, clearFields: any[] = [], fieldValue = {}) {
